...
namespace StreamLibrary
{
	...
	public abstract class IUnsafeCodec
	{
		...
		// (get) Token: 0x0600000E RID: 14 RVA: 0x0000224C File Offset: 0x0000224C
		// (set) Token: 0x0600000F RID: 15 RVA: 0x00002254 File Offset: 0x00002254
		private protected object ImageProcessLock { get; private set; }

		// Token: 0x17000006 RID: 6
		// (get) Token: 0x06000010 RID: 16 RVA: 0x00002260 File Offset: 0x00002260
		// (set) Token: 0x06000011 RID: 17 RVA: 0x00002268 File Offset: 0x00002268
		...
		// Token: 0x06000016 RID: 22 RVA: 0x0000228C File Offset: 0x0000228C
